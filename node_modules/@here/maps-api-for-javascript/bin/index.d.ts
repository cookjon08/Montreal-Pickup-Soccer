...
/* skipped emitting type alias H.lang.ArrayLike to avoid collision with existing one in lib.d.ts. */
...
declare namespace H.service {
  ...
  class SearchService extends H.service.Service {
    ...
    constructor (opt_options ? : H.service.Options ) ;
    /**
     * This method provides possible complete addresses by matching the input text terms to parts of an address.
     * [Geocoding and Search API](https://www.here.com/docs/category/geocoding-search-v7/).
     *
     * Please refer to the
     * [`/autocomplete` endpoint documentation](https://www.here.com/docs/bundle/geocoding-and-search-api-developer-guide/page/topics/endpoint-autocomplete-brief.html)
     * for information on available parameters and the response object structure.
     * @param params Contains service parameters to be sent with the request.
     * @param onResult A callback function to be called once the API provides a response to the request.
     * @param onError A callback function to be called if a communication error occurs during the request.
     */
    autocomplete (params : H.service.ServiceParameters , onResult : (a : GlobalObject ) => any , onError : (a : Error ) => any ) : H.util.ICancelable ;
    /**
...
declare namespace H.service.extension.TileProvider {
  /**
   * Configuration object which can be used to initialize the {@link H.service.extension.TileProvider}.
   */
...
declare namespace H.service.extension.TileProvider {
  /**
   * A Function to provide an individual style for a map object according to the passed row data.
   * See also {@link H.service.extension.TileProvider.Options#styleCallback}.
   */
...
declare namespace H.ui.base {
  ...
  class Element extends H.util.EventTarget {
    ...
    setDisabled (opt_disabled ? : boolean , opt_force ? : boolean ) : H.ui.base.Element ;
    /**
     * This method sets the tabIndex of the element.
